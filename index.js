...
let number1 = Number(window.prompt("Enter a number"));
let number2 = Number(window.prompt("Enter another number"));
const sum = number1 + number2;
window.alert(`Sum is ${sum}`);


// Implement a program that calculates the area of a rectangle using given length and width.
let length = Number(window.prompt("Enter length in cm"));
let width = Number(window.prompt("Enter width in cm"));
...
let voteAge = Number(window.prompt("Enter you age"));
if(voteAge>=18){
    window.prompt("You are eligible to vote")
}
else{
    window.prompt("You are not eligible to vote");
}
...
let limit = Number(window.prompt("Enter a limit"));
let oddSum = 0;
for(i=1; i<=limit; i++){
    if(i%2==1){
        oddSum = oddSum + i;
...
// ****
// *****
let height1 = Number(window.prompt("Enter a number to set height of the triangle1"));
...
let h2 = Number(window.prompt("Enter a number to set height of the triangle2"));
